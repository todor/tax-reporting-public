...
TAX_MODE_LISTING_EXCHANGE = "listing_exchange"
TAX_MODE_EXECUTION_EXCHANGE = "execution_exchange"
DEFAULT_TAX_EXEMPT_MODE = TAX_MODE_LISTING_EXCHANGE
...
REVIEW_STATUS_TAXABLE_FROM_HERE = "TAXABLE-FROM-HERE"
REVIEW_STATUS_NON_TAXABLE_FROM_HERE = "NON-TAXABLE-FROM-HERE"

NEGATIVE_PIL_MODE_POSITION_AWARE = "position-aware"
NEGATIVE_PIL_MODE_ALWAYS_NET = "always-net"
NEGATIVE_PIL_MODE_IGNORE = "ignore"
NEGATIVE_PIL_MODES = {
    NEGATIVE_PIL_MODE_POSITION_AWARE,
    NEGATIVE_PIL_MODE_ALWAYS_NET,
    NEGATIVE_PIL_MODE_IGNORE,
}
CFD_FINANCING_MODE_POSITION_AWARE = "position-aware"
CFD_FINANCING_MODE_ALWAYS_NET = "always-net"
CFD_FINANCING_MODE_IGNORE = "ignore"
CFD_FINANCING_MODES = {
    CFD_FINANCING_MODE_POSITION_AWARE,
    CFD_FINANCING_MODE_ALWAYS_NET,
    CFD_FINANCING_MODE_IGNORE,
}
POSITIVE_WHT_MODE_CURRENT_YEAR_NET = "current-year-net"
POSITIVE_WHT_MODE_PRIOR_YEAR_CORRECTION = "prior-year-correction"
POSITIVE_WHT_MODES = {
    POSITIVE_WHT_MODE_CURRENT_YEAR_NET,
    POSITIVE_WHT_MODE_PRIOR_YEAR_CORRECTION,
}
NEGATIVE_PIL_STATUS_NET = "NET"
NEGATIVE_PIL_STATUS_DEFER = "DEFER"
NEGATIVE_PIL_STATUS_IGNORE = "IGNORE"
NEGATIVE_PIL_STATUS_REVIEW = "REVIEW"
