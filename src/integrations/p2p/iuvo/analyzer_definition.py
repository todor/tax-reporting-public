...
from .report_analyzer import analyze_iuvo_report
...
def _add_arguments(parser: argparse.ArgumentParser, mode: CliMode) -> None:
    add_mode_argument(
        ...
        type=str,
        help="Iuvo secondary-market mode override",
    )
...
def _build_options(
    ...
    secondary_market_mode = option_value(
        ...
        aggregate_attr="iuvo_secondary_market_mode",
...
ANALYZER = AnalyzerDefinition(
    ...
    description="Iuvo PDF analyzer",
    input_suffixes=(".pdf",),
    detection_token_sets=(("iuvo",),),
