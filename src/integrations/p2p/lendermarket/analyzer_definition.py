...
from .report_analyzer import analyze_lendermarket_report
...
def _add_arguments(parser: argparse.ArgumentParser, mode: CliMode) -> None:
    add_mode_argument(
        ...
        type=str,
        help="Lendermarket secondary-market mode override",
    )
...
def _build_options(
    ...
    secondary_market_mode = option_value(
        ...
        aggregate_attr="lendermarket_secondary_market_mode",
...
ANALYZER = AnalyzerDefinition(
    ...
    description="Lendermarket PDF analyzer",
    input_suffixes=(".pdf",),
