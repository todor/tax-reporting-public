...
from integrations.shared.result_builders import build_fund_result

from .constants import APPENDIX_5_DECLARATION_CODE, DEFAULT_OUTPUT_DIR
from .report_analyzer import analyze_finexify_report
...
def _build_options(
    ...
    return {
        "opening_state_json": option_value(
            ...
            aggregate_attr="finexify_opening_state_json",
        ),
...
def _run(context: AnalyzerRunContext):
    ...
    return build_fund_result(
        ...
        declaration_code=APPENDIX_5_DECLARATION_CODE,
    )
...
ANALYZER = AnalyzerDefinition(
    ...
    group="fund",
    aliases=(),
    description="Finexify fund CSV analyzer",
    default_output_dir=DEFAULT_OUTPUT_DIR,
    input_suffixes=(".csv",),
    detection_token_sets=(("finexify",),),
