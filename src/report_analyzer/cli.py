...
_OVERRIDABLE_AGGREGATE_OPTIONS: tuple[_OverridableAggregateOption, ...] = (
    ...
    _OverridableAggregateOption(
        flag="cfd-financing-mode",
        group_key="cfd_financing_mode",
        takes_value=True,
        help="CFD financing / CFD interest handling mode where supported",
        display_label="CFD financing mode",
...
def _run_aggregate_mode(args: argparse.Namespace) -> int:
    ...
    group_options = {
        ...
        "cfd_financing_mode": args.cfd_financing_mode,
